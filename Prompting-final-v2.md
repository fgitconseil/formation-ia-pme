...
> **Note 2026 — Clarification terminologique**
> Ce guide utilise le terme **"Skills"** pour désigner la capitalisation des connaissances.
> Selon l'outil utilisé, le terme exact diffère :
> - Sur **claude.ai (interface web — managers, non-experts)** : la fonctionnalité équivalente s'appelle **Projets + Instructions de projet**. Accessible à tous, sans compétence technique.
> - Sur **Claude Code (CLI — développeurs)** : les Skills sont des fichiers `SKILL.md`. Ils nécessitent un terminal. Voir M10.
>
> **Cette formation (N1 et N2) cible l'interface claude.ai sauf mention explicite.**
...
- Créer des **Projets dédiés avec Instructions personnalisées** lorsque le travail devient récurrent ou structuré *(sur claude.ai : outil Projets ; sur Claude Code : Skills SKILL.md — voir M10)*
...
> **Note 2026 — Clarification terminologique**
> Cette section décrit des architectures techniques avancées (Claude Code / API Anthropic).
> Équivalents accessibles pour les managers sur claude.ai :
>
> | Terme technique | Équivalent manager sur claude.ai |
> |----------------|----------------------------------|
> | Agent (architecture orchestrée) | Workflow documenté + Projet structuré |
> | Mémoire (historique, contexte, état) | Fenêtre de contexte d'un Projet |
> | Logs d'activité | Suivi manuel dans le journal de bord |
> | Intégration via API | Connecteurs claude.ai |
>
> **Le déploiement d'agents techniques relève du N3 avancé (M10) et nécessite un support IT.**
> Les managers N1-N2 retiennent les principes de gouvernance, pas l'implémentation.
...
- **Mémoire** (historique, contexte, état) — *équivalent claude.ai : fenêtre de contexte d’un Projet*
