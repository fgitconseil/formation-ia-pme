...
M6 — vous savez capitaliser : Projects, Artifacts, Skills pour ne plus repartir de zéro.
...
**Étape 4 — Cycle 3 : appliquer la méthode 🟢→🟡**
...
Il couvre la création d'assistants personnalisés (M8), les bases de connaissance et Skills avancés (M9), et l'introduction aux connecteurs et agents (M10).
...
- [ ] **5. Project configuré** — J'ai créé au moins un Project pour un périmètre de travail réel. Il contient des instructions permanentes et au moins un document de référence.
...
**8/8 coché** → Vous êtes prêt pour le Niveau 3. Passez à M8.

**6-7/8 coché** → Vous êtes prêt avec une vigilance à maintenir. Notez les 1-2 points non cochés et revenez les cocher après vos prochaines séances de travail.

**5/8 ou moins** → Revenez sur les modules correspondant aux points non cochés avant de passer au Niveau 3. Ce n'est pas une sanction : le Niveau 3 amplifie les acquis N2. Si les bases manquent, l'amplification est celle des erreurs.
...
- Les fiches prompt Partie 1 peuvent être partagées en équipe pour créer une bibliothèque collective — c'est le premier pas vers 🟣 (Industrialiser)
