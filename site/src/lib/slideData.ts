...
export interface BlocConfig {
  ...
  ordre:       number;
  titre:       string;
  phase:       string;     // étiquette narrative affichée côté apprenant
  desc:        string;     // description courte pour le syllabus
  duree:       string;
  category:    string;     // "intro" | "partie1" | "partie2" | "partie3"
  scriptPath:  string;
  takeawayPath?: string;
  phaseColor:  string;     // classe Tailwind pour la pastille
}
...
export const BLOCS: BlocConfig[] = [
  {
    ...
    phase: 'Comprendre', phaseColor: 'bg-blue-600',
  ...
  },
  {
    ...
    phase: 'Comprendre', phaseColor: 'bg-blue-600',
    desc: "Les 3 risques professionnels réels — exfiltration, réputationnel, industrialisation prématurée.",
    category: 'intro', duree: '~20 min',
  ...
  },
  {
    ...
    phase: 'Choisir', phaseColor: 'bg-green-600',
    desc: "Les 4 intentions — Production, Exploration, Structuration, Vérification. Un mauvais type génère une mauvaise réponse.",
  ...
  },
  {
    ...
    phase: 'Méthode', phaseColor: 'bg-yellow-500',
    desc: "🟢 Structurer · 🟡 Fiabiliser · 🔵 Optimiser · 🟣 Industrialiser. Appliqué sur le cas Marc (RH).",
  ...
  },
  {
    ...
    phase: 'Outiller', phaseColor: 'bg-green-600',
    desc: "Ne plus repartir de zéro. Projets persistants, Artifacts exploitables, Instructions de Projet.",
    category: 'partie1', duree: '~20 min',
  ...
  },
  {
    ...
    phase: 'Conclusion', phaseColor: 'bg-purple-600',
    desc: "Skills, responsabilité déplacée, boucle amplificatrice et reddition cognitive. Intro Coach IA.",
